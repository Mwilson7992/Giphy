var buttonsHTML = '';
var topicArray = ['Dog', 'Cat', 'Hamster', 'Gorilla', 'Emu', 'Alpaca', 'Snake', 'Lizard', 'Pig', 'Horse', 'Donkey', 'Elephant', 'Ardvark', 'Giraffe', 'Alligator', 'Crocodile', 'Tiger', 'Lion', 'Bear', 'Meerkat', 'Panther', 'Jaguar'];
var newCountryValue;
var giphyKey = "S3fmMgUReSCS81Ap2tNk6gSqkjCn4RfM";
var searchAnimal;
var giphyHolder;
var giphyArray = [];
...
function generateButtons() {
     for (var i = 0; i < topicArray.length; i++) {
          buttonsHTML += "<button class='btn btn-lrg btn-primary animal-buttons' data-animal=" + topicArray[i] + ">" + topicArray[i] + "</button>";
     }
...
$('body').on('click', '.animal-buttons', function(event){
     ...
     queryURL = "https://api.giphy.com/v1/gifs/search?q=" + searchAnimal + "&limit=10" + "&api_key=S3fmMgUReSCS81Ap2tNk6gSqkjCn4RfM";
